                            ...
                            <div>
                                <ul class="pagination pagination-right">
                                    ...
                                    <li>
                                        ...
                                        <c:if test="${!fp}">
                                            <a href="<%=basePath%>user/studentPaper?cmd=list&index=${pager.pagectrl.currentindex-1}&spid=${spid}">上一页</a>
                                        </c:if>
                                    </li>
                                    <c:forEach begin="${pager.pagectrl.minpage}" step="1" end="${pager.pagectrl.maxpage}" var="index">
                                        <li>
                                            ...
                                            <c:if test="${!t}">
                                                <a href="<%=basePath%>user/studentPaper?cmd=list&index=${index}&spid=${spid}">${index}</a>
                                            </c:if>
                                        </li>
                                    </c:forEach>
                                    <li>
                                        ...
                                        <c:if test="${!fp}">
                                            <a href="<%=basePath%>user/studentPaper?cmd=list&index=${pager.pagectrl.currentindex+1}&spid=${spid}">下一页</a>
                                        </c:if>
                                    </li>
                                </ul>
                            </div>
